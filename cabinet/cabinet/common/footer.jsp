...
<div id="doormat">
    ...
    <div class="doormat_col_1_3">
        ...
        <ul class="footer-col-links">
            <li>
		    <a href="<%=http_base%>/en/index.html">Home</a>
            </li>
            <li>
		    <a href="<%=http_base%>/topics/en/index.html">Health topics</a>
            </li>
            <li>
		    <a href="<%=http_base%>/entity/gho/en/index.html">Data</a>
            </li>
            <li>
		    <a href="<%=http_base%>/entity/mediacentre/en/index.html">Media centre</a>
            </li>
            <li>
		    <a href="<%=http_base%>/publications/en/index.html">Publications</a>
            </li>
            <li>
		    <a href="<%=http_base%>/countries/en/index.html">Countries</a>
            </li>
            <li>
		    <a href="<%=http_base%>/entity/en/index.html">Programmes and projects</a>
            </li>
            <li>
		    <a href="<%=http_base%>/governance/en/index.html">Governance</a>
            </li>
            <li>
    ...
    <div class="doormat_col_2_3">
        ...
        <ul class="footer-col-links">
            <li>
		    <a href="<%=http_base%>/about/contacthq/en/index.html">Contacts</a>
            </li>
            <li>
		    <a href="<%=http_base%>/suggestions/faq/en/index.html">FAQs</a>
            </li>
            <li>
		    <a href="<%=http_base%>/entity/employment/en/index.html">Employment</a>
            </li>
            <li>
		    <a href="<%=http_base%>/suggestions/en/index.html">Feedback</a>
            </li>
            <li>
		    <a href="<%=http_base%>/about/privacy/en/index.html">Privacy</a>
            </li>
            <li>
		    <a href="<%=http_base%>/about/scamalert/en/index.html">E-mail scams</a>
            </li>
        </ul>
    </div>
    <!-- column -->
...
<div id="newsletter">
    ...
    <p class="more_stories">
        <a href="#" class="pull_newsletter" title="Sign up for WHO updates">Sign up for KHO updates</a>
    </p>
</div>
